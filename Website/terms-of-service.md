...
- You must provide an accurate email address and be at least 16 years old.
...
- Attempt to break, overload, reverse-engineer, or gain unauthorized access to the
  service.
- Abuse the review system (for example, attempting to evade usage limits).
...
- You keep ownership of the drafts you submit.
- You grant us permission to process, store, and display your content **to you** as
  needed to provide the service, and to review it to improve the Coach, as
...
We aim to keep the service running but don't guarantee uninterrupted availability,
and we may modify or discontinue features.
...
qualified attorney before publishing — particularly the liability, payment, and
governing-law sections, and anything affecting international users.*
